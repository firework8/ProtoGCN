...
This is the official PyTorch implementation for "Revealing Key Details to See Differences: A Novel Prototypical Perspective for Skeleton-based Action Recognition".
